...
\setbeamertemplate{background}{
  \begin{tikzpicture}
    \node[inner sep=0pt,outer sep=0pt,opacity=0.15] at (current page.center) {\includegraphics[width=\paperwidth,height=0.9\paperheight, keepaspectratio]{logo.pdf}};
...
\begin{frame}{Including GIFs}
	\begin{center}
	  \animategraphics[autoplay,loop,width=0.6\linewidth]{5}{figures/frame-}{0}{4}
	\end{center}
  \end{frame}
...
\begin{frame}
    ...
    \begin{block}{}
        ...
        the name for the complete Unix-compatible software system which 
        I am writing so that I can give it away free to everyone who can 
        use it\footnote{\citep{stallman1985gnu}.}"
    \end{block}
    EMACS is a real-time display editor which can be extended by the 
